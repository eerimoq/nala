...
{
    struct nala_instance_rename_parameters_with_name_t *current_p;
    struct nala_instance_rename_parameters_with_name_t *tmp_p;

    NALA_STATE_RESET(nala_mock_rename_parameters_with_name, current_p, tmp_p);
}
...
{
    struct nala_instance_rename_parameters_without_name_t *current_p;
    struct nala_instance_rename_parameters_without_name_t *tmp_p;

    NALA_STATE_RESET(nala_mock_rename_parameters_without_name, current_p, tmp_p);
}

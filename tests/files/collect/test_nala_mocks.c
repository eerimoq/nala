...
{
    NALA_STATE_RESET(nala_mock_bar);
}
...
{
    NALA_STATE_RESET(nala_mock_fie);
}
...
{
    NALA_STATE_RESET(nala_mock_fum);
}
...
{
    NALA_STATE_RESET(nala_mock_gam);
}
...
{
    NALA_STATE_RESET(nala_mock_hit);
}
